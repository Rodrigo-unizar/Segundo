...
int main(int argc, char * argv[])
{
    ...
    while (1)
    {
        ...
        // acepta la conexión
        clen = sizeof caddr;
        /*if ((recvfrom(sock,msg, sizeof(msg) ,0 ,(struct sockaddr *)&caddr, &clen)) < 0)
        {
            perror("Error al aceptar una nueva conexión (accept)");
            exit(1);
        }
        ...
        num = 0;
        do {
            if ((readbytes = recvfrom(sock,msg, sizeof(msg) ,0 ,(struct sockaddr *)&caddr, &clen)) < 0)
            {
