 ...
 * @file comun.c
 *
 * Este fichero contiene funciones comunes para trabajar con estructuras
 * de direcciones.
 */
#include <stdio.h>
#include <stdlib.h>
 ...
 * *sockaddr_storage*.
 *
 * @param saddr Estructura de dirección a imprimir.
 */
...
/**
 * Función que devuelve un puntero a una estructura de direcciones rellenada
 * con direcciones que cumplan los parámetros especificados.
 *
 * @param dir_servidor String con el nombre/dirección IP del equipo del
 *                     que queremos obtener la dirección. Si está vacío
 *                     (NULL) es que queremos la direccion del equipo local.
