...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_NUM = 3,                        /* NUM  */
  YYSYMBOL_EOL = 4,                        /* EOL  */
  YYSYMBOL_FLECHA = 5,                     /* FLECHA  */
  YYSYMBOL_PAR_IZQ = 6,                    /* PAR_IZQ  */
  YYSYMBOL_PAR_DER = 7,                    /* PAR_DER  */
  YYSYMBOL_COMA = 8,                       /* COMA  */
  YYSYMBOL_PC = 9,                         /* PC  */
  YYSYMBOL_GRAPH = 10,                     /* GRAPH  */
  YYSYMBOL_C_LL = 11,                      /* C_LL  */
  YYSYMBOL_A_LL = 12,                      /* A_LL  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUM", "EOL", "FLECHA",
  "PAR_IZQ", "PAR_DER", "COMA", "PC", "GRAPH", "C_LL", "A_LL", "$accept",
  "g", "s", "$@1", "exp", YY_NULLPTR
};
...
{
      -7,   -10,     4,     1,   -11,     3,     2,    -3,   -11,     5,
       7,   -11,     6,    -8,     8,     7,     9,    10,    11,     3,
     -11,   -11
};
...
{
      15,    16,     3,     1,     4,     5,     6,     8,     9,    11,
      12,    17,    14,    19,    21,    18,     0,    20,     0,    15
};

static const yytype_int8 yycheck[] =
{
       8,     9,    12,    10,     0,     4,     3,     5,    11,     4,
       3,     3,     6,     4,    19,    15,    -1,     7,    -1,     8
};
...
{
       0,    10,    14,    12,     0,     4,     3,    15,     5,    11,
      16,     4,     3,    17,     6,     8,     9,     3,    17,     4,
       7,    15
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* $@1: %empty  */
#line 94 "th_plantilla.y"
                 {nodoFila = transformar((yyvsp[-1].nombre));}
#line 1223 "y.tab.c"
    break;

  case 6: /* exp: NUM PAR_IZQ NUM PAR_DER  */
#line 97 "th_plantilla.y"
                                {nodoColumna = transformar((yyvsp[-3].nombre));
                                 transicion = (yyvsp[-1].nombre);   //guardamos la tras
