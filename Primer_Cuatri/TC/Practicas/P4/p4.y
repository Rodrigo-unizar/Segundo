...
s:  /* nada */
    | NUM FLECHA exp PC EOL s   {nodoFila = transformar($1);}   //pasamos el número de la fila a un índice válido para la matriz   sigue estando dentro de la misma expresion
    ;
